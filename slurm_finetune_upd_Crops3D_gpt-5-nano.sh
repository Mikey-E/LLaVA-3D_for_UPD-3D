...
#SBATCH --job-name=llava-3d_ft_upd_Crops3D_gpt-5-nano
#SBATCH --output=./slurm_logs/llava-3d_ft_upd_Crops3D_gpt-5-nano%j.out
#SBATCH --error=./slurm_logs/llava-3d_ft_upd_Crops3D_gpt-5-nano%j.out
#SBATCH --gres=gpu:5
#SBATCH --mem=144G
...
bash scripts/train/finetune_upd_Crops3D_gpt-5-nano.sh