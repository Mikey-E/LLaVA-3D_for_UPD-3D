...
#SBATCH --job-name=llava-3d_ft_upd_3D-FRONT
#SBATCH --output=./slurm_logs/llava-3d_ft_upd_3D-FRONT%j.out
#SBATCH --error=./slurm_logs/llava-3d_ft_upd_3D-FRONT%j.out
#SBATCH --gres=gpu:5
#SBATCH --mem=144G
...
bash scripts/train/finetune_upd_3D-FRONT.sh